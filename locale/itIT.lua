local L = LibStub("AceLocale-3.0"):NewLocale("ButtonTimers", "itIT")
...
Frasi non corrette o non tradotta può essere aggiornato tramite lo strumento di localizzazione 
per questo addon a http://www.curseforge.com/addons/buttontimers/localization/.
Si prega di avvisare l'autore, stencil, con messaggio privato dopo aver effettuato tutti gli 
aggiornamenti in modo che una nuova generazione avranno rilasciato contenente le nuove traduzioni.
--]==]
