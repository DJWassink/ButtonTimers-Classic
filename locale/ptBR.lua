local L = LibStub("AceLocale-3.0"):NewLocale("ButtonTimers", "ptBR")
...
Frases incorretas ou não traduzida pode ser atualizado através da ferramenta de localização 
para este addon no http://www.curseforge.com/addons/buttontimers/localization/.
Por favor notifique o autor, stencil, por mensagem privada depois de fazer quaisquer 
atualizações para que uma nova compilação vai ficar liberados contendo as novas traduções.
--]==]
