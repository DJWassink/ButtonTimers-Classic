local L = LibStub("AceLocale-3.0"):NewLocale("ButtonTimers", "esMX")
...
Frases incorrectas o no traducidas se pueden actualizar a través de la herramienta de 
localización para este addon en http://www.curseforge.com/addons/buttontimers/localization/.
Por favor notifique al autor, stencil, por mensaje privado después de hacer las actualizaciones 
para que una nueva generación se consiguen lanzados que contenían las nuevas traducciones.
--]==]
