local L = LibStub("AceLocale-3.0"):NewLocale("ButtonTimers", "deDE")
...
Falsche oder nicht übersetzten Sätze können durch die Lokalisierungs-Tool für dieses 
Addon am http://www.curseforge.com/addons/buttontimers/localization/ aktualisiert werden.
Bitte benachrichtigen Sie den Autor, stencil, per privater Nachricht, nachdem Sie alle 
Updates, so dass ein Neubau veröffentlicht mit den neuen Übersetzungen zu bekommen.
--]==]
...
L["Bar Enabled"] = "Leiste aktiviert"
L["Bar Font"] = "Leistenschrift"
L["Bar Length"] = "Leistenlänge"
L["Bar Locked"] = "Leiste gesperrt"
L["Bar Scale"] = "Leistenskalierung"
L["Bar Time"] = "Leistenzeit"
--[[Translation missing --]]
--[[ L["Boss"] = "Boss"--]] 
--[[Translation missing --]]
--[[ L["Boss #1"] = "Boss #1"--]] 
...
L["Button Spacing"] = "Buttonabstand"
--[[Translation missing --]]
...
L["Enable"] = "Aktivieren"
L["Enable this bar"] = "Diese Leiste aktivieren"
...
L["Hide in pet battles"] = "In Haustierkämpfen verstecken"
L["Hide out of combat"] = "Außerhalb des Kampfes verstecken"
L["Hide this bar during pet battles"] = "Diese Leiste während Haustierkämpfen verstecken"
L["Hide Tooltips"] = "Tooltips verstecken"
L["Hide tooltips on buttons"] = "Tooltips auf Buttons verstecken"
...
L["Length of bar in pixels"] = "Länge der Leiste in Pixeln"
--[[Translation missing --]]
...
L["Party/Raid Member"] = "Gruppen-/Schlachtzugsmitglied"
L["Pet"] = "Begleiter"
L["Player"] = "Spieler"
--[[Translation missing --]]
--[[ L["Primary"] = "Primary"--]] 
...
L["Show Aura Icon"] = "Aurasymbol anzeigen"
L["Show background bar"] = "Hintergrundleiste anzeigen"
--[[Translation missing --]]
--[[ L["Show debug messages"] = "Show debug messages"--]] 
--[[Translation missing --]]
--[[ L["Show estimate of next dot tick time."] = "Show estimate of next dot tick time."--]] 
L["Show others spells"] = "Andere Zauber anzeigen"
L["Show this bar only when in combat"] = "Diese Leiste nur im Kampf anzeigen"
L["Show this spell on the target even if someone else cast it."] = "Diesen Zauber auf dem Ziel anzeigen, selbst wenn er von jemand anderem gewirkt worden ist."
--[[Translation missing --]]
...
L["Texture of the status bar"] = "Textur der Statusleiste"
--[[Translation missing --]]
--[[ L["The party / raid member to target"] = "The party / raid member to target"--]] 
L["The space between the buttons"] = "Der Platz zwischen den Buttons"
--[[Translation missing --]]
--[[ L["Timer Location"] = "Timer Location"--]] 
L["Timer Type"] = "Timertyp"
--[[Translation missing --]]
