local L = LibStub("AceLocale-3.0"):NewLocale("ButtonTimers", "frFR")
...
Expressions incorrectes ou non traduite peut être mis à jour via l'outil de localisation 
pour cet addon à http://www.curseforge.com/addons/buttontimers/localization/.
S'il vous plaît aviser l'auteur, stencil, par message privé après avoir effectué des mises 
à jour de sorte qu'une nouvelle génération se faire libérés contenant les nouvelles traductions.
--]==]
