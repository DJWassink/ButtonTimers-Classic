local L = LibStub("AceLocale-3.0"):NewLocale("ButtonTimers", "ruRU")
...
Неправильное или непереведенные фразы могут быть обновлены через локализацию инструмент 
для этого аддона на http://www.curseforge.com/addons/buttontimers/localization/.
Пожалуйста, сообщите автору, stencil, на личное сообщение после внесения обновлений, 
так что новое строительство будет выпущен содержащий новые переводы.
--]==]
