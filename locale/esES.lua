local L = LibStub("AceLocale-3.0"):NewLocale("ButtonTimers", "esES")
...
Frases incorrectas o no traducidas se pueden actualizar a trav�s de la herramienta de 
localizaci�n para este addon en http://www.curseforge.com/addons/buttontimers/localization/.
Por favor notifique al autor, stencil, por mensaje privado despu�s de hacer las actualizaciones 
para que una nueva generaci�n se consiguen lanzados que conten�an las nuevas traducciones.
--]==]
